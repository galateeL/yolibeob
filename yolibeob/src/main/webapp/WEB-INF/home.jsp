...
<div class="container mt-5" id="home-container">
    ...
    <div class="d-flex justify-between flex-row align-items-center m-5">
        <img src="https://preview.redd.it/nr44vhxhjif71.jpg?auto=webp&s=08dc15fce9e1d54cc288c79c069afde74db53863" alt=""
             style="width: 100px"/>
                ...
                <div class="card" style="width: 300px">
                    ...
                    <div class="card-body d-flex flex-column">
                        <h5 class="card-title text-center"
                            style="font-family: 'Pacifico', cursive; color: #1c1b1b">${recipe.title}</h5>
                    </div>
