...
<div class="container mb-5">
    <div class="row d-flex justify-content-center">
        <img class="col-9" id="addRecipe-banner"
             src="https://images.unsplash.com/photo-1543352634-a1c51d9f1fa7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
             alt="">
        ...
        <div class="col-9" id="addRecipe-bg">
            ...
            <form action="${pageContext.request.contextPath}/auth/addRecipe" method="POST" class="m-5">
                <div class="mb-3">
                ...
                <button type="submit" class="btn" style="background: #ff5630; color: white">Continue and add
                    ingredients
                </button>
            </form>
        </div>
